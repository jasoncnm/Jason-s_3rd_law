...
set EXPORTED_FUNCTIONS=/EXPORT:UpdateAndRender /EXPORT:Initialize 
set COMMON_FLAGS=/Zi /nologo -GR- -Od -Oi -WX -W4 -wd4456 -wd4505 -wd4201 -wd4100 -wd4189 -wd4996 -FC
...
del lock.file
cl ..\src\main.cpp /D_AMD64_ /Fe:%EXE_NAME% %COMMON_FLAGS% %LINKER_FLAGS% %WARNINGS%
