...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::Person_PhoneNumber)},
        {7, sizeof(::Person)},
        {18, sizeof(::AddressBook)},
};
...
const char descriptor_table_protodef_test_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "ssBook\022\027\n\006people\030\001 \003(\0132\007.Personb\010edition"
    "sp\351\007"
};
...
PROTOBUF_NDEBUG_INLINE Person_PhoneNumber::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::Person_PhoneNumber& from_msg)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 4, 1, 24, 2>
Person::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(Person, _impl_._has_bits_),
    0, // no _extensions_
...
PROTOBUF_NDEBUG_INLINE AddressBook::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::AddressBook& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
